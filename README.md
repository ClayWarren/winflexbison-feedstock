...
Package license: GPL-3.0-or-later AND BSD-3-Clause
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/winflexbison-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/winflexbison-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add winflexbison
# for installing globally
pixi global install winflexbison
```
...
It is possible to list all of the versions of `winflexbison` available on your platform:
...
```
pixi search winflexbison --channel conda-forge
```
